...
public class Question {
    ...
    public Question(int id, String questionContent, int chapterId, String chapterName, int dimensionId, String dimensionName, int subjectId, String explanation, int isActive, int createdBy, String createrName, String createAt, int updatedBy, String updater, String updateAt) {
        this.id = id;
