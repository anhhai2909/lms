...
public class Classs {
    ...
    public Classs(int id, int semester_id, int subject_id, String class_name, int trainer_id, Timestamp start_date, Timestamp end_date, String description, int is_active, int created_by, Timestamp created_at, int updated_by, Timestamp updated_at) {
        this.id = id;
    ...
    public Classs(int id, int semester_id, int subject_id, String class_name, int trainer_id, Timestamp start_date, Timestamp end_date, String description, int is_active, int created_by, Timestamp created_at, int updated_by, Timestamp updated_at, String created_by_name, String updated_by_name, String trainer_name, String subject_code, String semester_name) {
        this.id = id;
        this.semester_id = semester_id;
        this.subject_id = subject_id;
        this.class_name = class_name;
