...
//    }
//
//public ArrayList<Class> GetClassByID(int id) {
//String sql = "SELECT class.*, " +
//             "u1.fullname AS created_by_name, " +
//             "u2.fullname AS updated_by_name, " +
//             "u3.fullname AS trainer_name, " +
...
//            ResultSet rs = st.executeQuery();
//            if (rs.next()) {
//                Class classes = new Class(rs.getInt("id"),
//                        rs.getInt("semester_id"),
//                        rs.getInt("subject_id"),
//                        rs.getString("class_name"),
//                        rs.getInt("trainer_id"),
...
//    }
//
//    public Class getClassByName(String classes_name) {
...
//    }
//
//    public Class checkUpdateClass(String checkContent, String newContent, int id) {
...
//    }
//
//    public Class checkClassByName(String newName, String oldName) {
//        String sql = "select * from class\n"
...
//    }
//
//    public ArrayList<Class> getClassByPage(ArrayList<Class> list, int start, int end) {
...
//        }
//     */
//    public ArrayList<Class> SearchClassByID(int id) {
...
//    }
//
//    public ArrayList<Class> SearchClassByName(String classes_value) {
...
//    }
//
//    public ArrayList<Class> SearchClassByType(String classes_name) {
//        String sql = "select * from class where class_name like ? order by class.id";
//        try {
//            PreparedStatement st = connection.prepareStatement(sql);
//            st.setString(1, "%" + classes_name + "%");
...
//    }
//
//    public ArrayList<Class> SearchClassByStatus(int is_active) {
...
//    }
//
//public ArrayList<Class> searchClasses(String className, int semesterID, int subjectID, int trainerID, int is_Active) {
//    ArrayList<Class> classesList = new ArrayList<>();
//
...
//ClassDAO a = new ClassDAO();
// List<Class> list = a.searchClasses("se",16,0,0,1);
...
////  a.AddClass("Role", "Arduin FDTI", 1, 2, "It is IOT", 1, created_at);
//        //  List<Class> list = a.SearchClassByStatus(1);
//        //  System.out.println(list.get(0).toString());
//    }
//}
