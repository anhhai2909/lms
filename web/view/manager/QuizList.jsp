                                                ...
                                                <tr class="row" style="line-height: 30px">       
                                                    ...
                                                    <td class="col-md-2" style="text-align: center">
                                                        <div>
                                                            ...
                                                            <i onclick="window.location.href = 'Quizz?action=detailQuiz&quizID=${q.getQuiz_id()}'" class="fa fa-eye" id="view_icon" style = "cursor: pointer"  ></i>
                                                            &nbsp;&nbsp;
                                                            <i onclick="openDeleteModal('${q.quiz_id}')" class="fa fa-trash"style = "cursor: pointer"></i>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </c:forEach>
