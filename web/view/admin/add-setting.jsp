<%-- 
    ...
    Created on : Sep 24, 2023, 8:06:50 AM
    Author     : OS
--%>
                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            ...
                            <div class="widget-inner">
                                <form name="settingForm" id="settingForm" action="settinglist" method="addSetting" class="edit-profile m-b30" onsubmit="<%= isLoggedIn ? "return validateAndSubmit();" : "return checkLoginStatus();"%>">
                                    <!-- Your existing form code here -->
                                    <input type="text" name="action" style="display: none" value="addSetting">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="ml-auto">
                                                <h3>Basic info</h3>
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input class="form-control" type="text" name="setting_value" value="<%= (request.getParameter("setting_value") != null) ? request.getParameter("setting_value") : "" %>">
                                                <span id="settingValueError" style="color: red;">
                                                    <% if (request.getAttribute("addFailure") != null) { %>
                                                    <font color="red">This setting value already exists!</font>
                                                    <% } %>
                                                </span>
                                            </div>
                                        </div>
                                        <div class="form-group col-3">
                                            ...
                                            <div>
                                                <select class="form-control" name="setting_name">
                                                    <option value="Semester" <%= ("Semester".equals(request.getParameter("setting_name"))) ? "selected" : "" %>>Semester</option>
                                                    <option value="Role" <%= ("Role".equals(request.getParameter("setting_name"))) ? "selected" : "" %>>Role</option>
                                                    <option value="Permitted Mail Domain" <%= ("Permitted Mail Domain".equals(request.getParameter("setting_name"))) ? "selected" : "" %>>Permitted Mail Domain</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input class="form-control" type="number" name="display_order" value="<%= request.getParameter("display_order") %>">
                                            </div>
                                        </div>
                                        <div class="form-group col-3">
