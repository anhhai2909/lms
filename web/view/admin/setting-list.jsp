<%-- 
    ...
    Created on : Sep 23, 2023, 1:14:27 AM
    Author     : OS
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <!-- DESCRIPTION -->
        <meta name="description" content="Setting List" />
...
boolean isLoggedIn = (session.getAttribute("isLoggedIn") != null && (Boolean) session.getAttribute("isLoggedIn"));
                                ...
                                <form action="settinglist" method="get" class="row">
                                    <div class="row" style="margin-bottom: 10px">
                                        <input type="text" name="action" style="display: none" value="listSetting">
                                        <label style = "margin-right: 20px; margin-top: 10px;">Search:</label>
                                        <input type="text" name="searchLabel1" id="searchLabel1" placeholder="Enter setting name" style="line-height: 30px; width: 400px;border-radius: 10px; border: 1px solid #C6C6C6" value="${searchLabel1}"/>                                     
                                        <select name="searchLabel2" style="line-height: 30px; height: 30px; margin-left: 50px; border: 1px solid #C6C6C6">
                                            <option value="" ${empty searchLabel2 ? "selected" : ""}>All Types</option>
                                            <option value="Semester" ${searchLabel2 == 'Semester' ? "selected" : ""}>Semester</option>
                                            <option value="Role" ${searchLabel2 == 'Role' ? "selected" : ""}>Role</option>
                                            <option value="Permitted Mail Domain" ${searchLabel2 == 'Permitted Mail Domain' ? "selected" : ""}>Permitted Mail Domain</option>
                                        </select>
                                        <select name="searchLabel3" style="line-height: 30px; height: 30px; margin-left :50px; border: 1px solid #C6C6C6">
                                            <option value="-1" ${searchLabel3 == -1 ? "selected" : ""}>All Statuses</option>
                                            <option value="1" ${searchLabel3 == 1 ? "selected" : ""}>Activated</option>
                                            <option value="0" ${searchLabel3 == 0 ? "selected" : ""}>Deactivated</option>
                                        </select>
                                    </div>
...
<button class="button" onclick="window.location.href = 'settinglist?action=addScreen';" style="float:right"><i class="fas fa-plus" style="margin-right: 5px"></i>Add New</button>
<button class="button" onclick="window.location.href = 'settinglist?action=listSetting';" style="float:right; margin-right:20px;"><i class="glyphicon glyphicon-refresh" style="margin-right: 5px"></i>Reset</button>

                                <br>
                                <table id="data-table" style = "margin-top: 30px">
                                    <thead style = "background-color: white;">
                                        <tr class="row" style="line-height:50px;background-color: white;">
                                            <th class="col-md-1 sortable" style="border-right: 1px solid silver; font-size: 16px; cursor: pointer;"><span style="font-weight: 500;font-family:Rubik;">ID*</span></th>
                                            <th class="col-md-2 sortable" style = "border-right: 1px solid silver; font-size: 16px; color: #505050;"><span style="font-weight: 500;font-family:Rubik;">Name</span></th>
                                            <th class="col-md-2 sortable" style = "border-right: 1px solid silver; font-size: 16px; color: #505050;"><span style="font-weight: 500; font-family:Rubik;">Type</span></th>
                                            <th class="col-md-2 sortable" style = "border-right: 1px solid silver; font-size: 16px; color: #505050;"><span style="font-weight: 500; font-family:Rubik;">Status</span></th>
                                            <th class="col-md-2 sortable" style = "border-right: 1px solid silver; font-size: 16px; color: #505050;"><span style="font-weight: 500; font-family:Rubik;">Order</span></th>
                                            <th class="col-md-2" style = "border-right: 1px solid silver; font-size: 16px; color: #505050;"><span style="font-weight: 500; font-family:Rubik;">Action</span></th>
                                            <th class="col-md-1" style = "border-right: 1px solid silver; font-size: 16px; color: #505050;"><span style="font-weight: 500; font-family:Rubik;">Details</span></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    <form action="settinglist" method="get" class="edit-profile m-b30">
                                        <input type="text" name="action" style="display: none" value="listSetting">
                                        <c:forEach items="${requestScope.settings}" var="i">
                                            <tr class="row" style="border-bottom: 1px solid #D9D9D9">
                                                ...
                                                <td class="col-md-2" style = "border-right: 1px solid silver; font-size: 14px;color: black;">${i.setting_value}</a></td>
                                                <td class="col-md-2" style = "border-right: 1px solid silver; font-size: 14px;color: black;">${i.setting_name}</td>
                                                ...
                                                <td class="col-md-2" style = "border-right: 1px solid silver; font-size: 14px;">${i.display_order}</td>
                                                <td class="col-md-2" style = "border-right: 1px solid silver">   
                                                    <div class="button-container">
                                                        <div>
                                                            <a href="settinglist?action=updateSet&id=${i.id}"><i class="fas fa-edit" style="color: black; cursor: pointer;" onmouseover="this.style.color = 'blue'" onmouseout="this.style.color = 'black'"></i></a>
                                                        </div>
                                                ...
                                                <td class="col-md-1" style="border-right: 1px solid silver"><a href="settinglist?action=detailScreen&id=${i.id}"><i class="fa fa-eye" style="color: black; cursor: pointer;" onmouseover="this.style.color = 'blue'" onmouseout="this.style.color = 'black'"></i></a></td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                    </form>
                ...
                <div class="pagination">
                    <ul class="pagination">
                        ...
                        <li>
                            <input type="number" id="pageNumberInput" min="1" max="${Math.ceil(totalItems / pageSize)}">
...
<script>
                                                    ...
                                                    var currentPage = 1;
                                                    var totalItems = ${requestScope.settings.size()}; // Total number of items, replace with actual value
                                                    ...
                                                    // Numeric sorting for ID and Order columns
...
// Enter key press event for page number input
        ...
        <script>
            ...
            window.location.href = "settinglist?action=delete&id=" + id;
            }
            }
        </script>
        <script>
            ...
            window.location.href = "settinglist?action=activate&status-then=1&id=" + id;
            }
            });
            }
            ...
            window.location.href = "settinglist?action=activate&status-then=0&id=" + id;
            }
            });
            }
