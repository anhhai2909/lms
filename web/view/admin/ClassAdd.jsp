        ...
        <main class="ttr-wrapper">
            <div class="container-fluid">
                <div class="db-breadcrumb">
                    <h4 class="breadcrumb-title">Add Classes</h4>
                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            ...
                            <div class="widget-inner">
                                <form name="classListForm" id="classListForm" action="classes" method="addClass" class="edit-profile m-b30" onsubmit="<%= isLoggedIn ? "return validateAndSubmit();" : "return checkLoginStatus();"%>">
                                    <!-- Your existing form code here -->
                                    <input type="text" name="action" style="display: none" value="addClass">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="ml-auto">
                                                <h3>Basic info</h3>
                                            </div>
                                                                                            <span id="settingValueError" style="color: red; font-weight: bold;">
                                                    <% if (request.getAttribute("addFailure") != null) { %>
                                                    <font color="red">This class has already assigned that subject in that semester! Please add new class with other subjects in the semester.</font>
                                                    <% } %>
                                                </span>
                                        </div>
                                        <div class="form-group col-3">
                                            ...
                                            <div>
                                                <input class="form-control" type="text" name="class_name" value="<%= (request.getParameter("class_name") != null) ? request.getParameter("class_name") : "" %>">
                                            </div>
                                        </div>
                                        <div class="form-group col-3">
                                            ...
                                            <div>
                                                <select class="form-control" name="semester_id">
                                                    <c:forEach var="c" items="${requestScope.semesters}">
                                                        <option value="${c.id}">${c.setting_value}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-3">
                                            ...
                                            <div>
                                                <input type="hidden" name="is_active" value="0"> <!-- Hidden input with default value "0" -->
                                                <label class="switch">
                                                    <input type="checkbox" name="is_active_checkbox" value="1" <%= ("1".equals(request.getParameter("is_active"))) ? "checked" : "" %>>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <textarea class="form-control" rows="4" name="description"><%= (request.getParameter("description") != null) ? request.getParameter("description") : "" %></textarea>
                                            </div>
                                        </div>
                                    </div>
