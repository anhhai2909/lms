                                ...
                                <form action="users" method="get" id="userForm" class="edit-profile m-b30">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            <label class="col-form-label">Full Name (how your name will appear to other users on the site)</label>
                                            <div>
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input name="email" class="form-control" type="email" placeholder="Enter your email" value="${us.email}" required>
                                            </div>
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input name="phone" class="form-control" type="text" placeholder="Enter your phone number" value="${us.phone}" required>
                                            </div>
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <div>
                                                <input name="password" class="form-control" type="password" placeholder="Enter your password" value="${us.password}" required>
                                            </div>
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <div>
                                                <textarea name="avatar" class="form-control" placeholder="Insert avatar URL">${us.avatar}</textarea>
                                            </div>  
                                        </div>
