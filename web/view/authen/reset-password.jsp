            ...
            <div class="account-form">
                ...
                <div class="account-form-inner">
                    <div class="account-container">
                        ...
                        <form class="contact-bx" action="${pageContext.request.contextPath}/Account?action=reset" method="post">
                            <!--<form class="contact-bx" action="${pageContext.request.contextPath}/ResetPassword" method="POST">-->
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input name="confPassword" type="password" required="" class="form-control">
                                            </div>
                                        </div>
                                    </div>
