            ...
            <div class="account-form">
                ...
                <div class="account-form-inner">
                    <div class="account-container">
                        ...
                        <form class="contact-bx" action="${pageContext.request.contextPath}/Account?action=forgot" method="post">
                        <!--<form class="contact-bx" action="${pageContext.request.contextPath}/ForgotPassword" method="POST">-->
