<%-- 
    ...
    Created on : Sep 17, 2023, 2:35:10 PM
    Author     : bao chau
--%>
        ...
        <!-- header start -->
                ...
                <div class="ttr-logo-box">
                    <div>
                        <a href="index.html" class="ttr-logo">
                            <img alt="" class="ttr-logo-mobile" src="assets_Admin/images/logo-mobile.png" width="30" height="30">
                            <img alt="" class="ttr-logo-desktop" src="assets_Admin/images/logo-white.png" width="160" height="27">
                        </a>
                    </div>
                </div>
                <!--logo end -->
                ...
                <div class="ttr-header-right ttr-with-seperator">
                    ...
                    <ul class="ttr-header-navigation">
                        ...
                        <li>
                            <a href="#" class="ttr-material-button ttr-submenu-toggle"><span class="ttr-user-avatar"><img alt="" src="assets_Admin/images/testimonials/pic3.jpg" width="32" height="32"></span></a>
                            <div class="ttr-header-submenu">
                                <ul>
